public static partial class libm
{
    ...
    private static readonly uint[] ATAN_HI = new uint[]
    {
    ...
    private static readonly uint[] ATAN_LO = new uint[]
    {
    ...
    private static readonly uint[] A_T = new uint[]
    {
    ...
    /// </summary>
    public static sfloat atanf(sfloat x)
    {
        sfloat z;
